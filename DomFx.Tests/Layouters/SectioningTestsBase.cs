...
{
    public class SectioningTestsBase
    {
        ...
        protected IEnumerable<Page> LayoutWithPage(DomFx.Layouters.Unit width, DomFx.Layouters.Unit height)
        {
        ...
        protected class ElementAssertionWrapper
        {
            ...
            public void ShouldBeAt(int page, DomFx.Layouters.Unit left, DomFx.Layouters.Unit top, DomFx.Layouters.Unit height)
            {
